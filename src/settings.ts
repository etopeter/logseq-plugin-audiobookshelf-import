...
export const settingsSchema: SettingSchemaDesc[] = [
    ...
    },
    {
        ...
        title: "API Token",
        description: "Audiobookshelf uses a users API token as a Bearer token for requests. You can find your API token by logging into the Audiobookshelf web app as an admin, go to the config → users page, and click on your account.",
    },
    {
        key: "libraryNameList",
        type: "string",
        default: "",
        title: "Library names",
        description: "Enter comma separated library names to import. Default empty will import all. If you have 2 libraries named Audiobooks and Podcasts you can select them with following match 'Audiobooks,Podcasts'",
    },
    {
    ...
    },
    {
        ...
        default: false,
        title: "Create pages",
        description: "Enables page creation for each Audiobookshelf item. Page title prefix and postfix can be configured to customize page titles.",
    },
    {
        key: "updatePages",
        type: "boolean",
        default: false,
        title: "Update pages",
        description: "If enabled it will update first block of existing pages. Warning: existing data in first block of the page will be lost.",
    },
    {
        key: "pageTitlePrefix",
        type: "string",
        ...
        description: "Prefix to add to item title. Allowed variables: {{{mediaType}}} - Audiobookshelf item type (book or podcast). This can be used to add namespace (hardcoded) eg. 'books/' or use variable to dynamically assign namespace '{{{mediaType}}}/'.\nWarning: Changing values on pages already created will create new pages and old pages will need to be deleted manually.",
    },
    {
        ...
        description: "Postfix to add to item title. This can be used to add additional data to ensure uniquess eg. ' (Audiobookshelf)' \nWarning: Changing values on pages already created will create new pages and old pages will need to be deleted manually.",
    },
    {
